...
public class claveCambio extends javax.swing.JFrame {
    ...
    /**
     * Creates new form claveCambio
     * @param usuario
     */
    public claveCambio(String usuario) {
        usuarioBL = new UsuariosBL();
        initComponents();
        setIconImage(new ImageIcon(getClass().getResource("/Imagenes/cambiar_clave.png")).getImage());
        ...
        if (control()) {
            if (controlClave()) {
                ...
                if (cambio == null) {
                    ...
                    abrirSeguridad(txtUsuario.getText());
                    limpiarControles();
                    this.dispose();                    
                } else {
    ...
    private void abrirSeguridad(String usuario){
        preguntaCambio seguridad=new preguntaCambio(usuario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(claveCambio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new claveCambio("").setVisible(true);
            }
        });
    }
